...
5. **Отчёт по практике**
   - Составьте отчёт по проектной (учебной) практике на основании шаблона (структуры), размещённого в папке reports. Шаблон (структура) приведён в файле [Структура_отчета_по_проектной_практике_2026.docx](Finatlon0607/reports/Структура_отчета_по_проектной_практике_2026.docx).
