...
5. **Отчёт по практике**
   - Составьте отчёт по проектной (учебной) практике на основании шаблона (структуры), размещённого в папке reports. Шаблон (структура) приведён в файле [Структура_отчета_по_проектной_практике_2026.docx](https://github.com/NikitaStar635/Finatlon0607/blob/main/reports/Структура_отчета_по_проектной_практике_2026.docx).
...
3. Официальная документация Git:
